#include "WarehouseIntersectionsAverageTime.h"

WarehouseIntersectionsAverageTime::~WarehouseIntersectionsAverageTime(void){
  delete whGraph ;
  whGraph = 0 ;
...
void WarehouseIntersectionsAverageTime::SimulateEpoch(bool train){
  size_t teamSize ;
  if (train)
    teamSize = 2*nPop ;
  else
...
void WarehouseIntersectionsAverageTime::SimulateEpoch(vector<size_t> memberIDs){
  double maxEval = 0.0 ;
  vector<size_t> travelStats ;
...
void WarehouseIntersectionsAverageTime::InitialiseMATeam(){
...
void WarehouseIntersectionsAverageTime::QueryMATeam(vector<size_t> memberIDs, vector<double> &a, vector<size_t> &s){
  vector<Edge *> e = whGraph->GetEdges() ;
...
void WarehouseIntersectionsAverageTime::GetJointState(vector<Edge *> e, vector<size_t> &s, vector<double> &eTime){
...
size_t WarehouseIntersectionsAverageTime::GetAgentID(int v){
  size_t vID ;
