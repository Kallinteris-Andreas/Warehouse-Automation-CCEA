...
class WarehouseIntersectionsBothTime : public Warehouse {
  public:
    WarehouseIntersectionsBothTime(YAML::Node configs) : Warehouse(configs){}
    ~WarehouseIntersectionsBothTime(void) ;
